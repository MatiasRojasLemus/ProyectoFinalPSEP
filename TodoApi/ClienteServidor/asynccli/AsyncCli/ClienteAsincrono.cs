...
namespace TodoApi.ClienteServidor.asynccli.AsyncCli
{
    ...
    public class AsynchronousClient
    {
        ...
        private static Pelicula CrearPeliculaCA()
        {
            ...
            return new Pelicula(titulo, nombre, sinopsis, precio);
        }
        ...
        private static Cliente CrearClienteCA()
        {
            ...
            return new Cliente(nombre, apellido1, apellido2);
        }
        ...
        private static bool IsNumeric(string inputString)
        {
            return(
                ...
                (inputString is null && int.TryParse(inputString, out int myInt))

                ||

                (inputString is null && double.TryParse(inputString, out double myDouble))
